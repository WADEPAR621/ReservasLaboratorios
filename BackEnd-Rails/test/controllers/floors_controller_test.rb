...
class FloorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create floor" do
    assert_difference("Floor.count") do
      post floors_url, params: { floor: { DES_PIS: @floor.DES_PIS, IMG_PIS: @floor.IMG_PIS, NOM_PIS: @floor.NOM_PIS } }
    end
  ...
  test "should update floor" do
    patch floor_url(@floor), params: { floor: { DES_PIS: @floor.DES_PIS, IMG_PIS: @floor.IMG_PIS, NOM_PIS: @floor.NOM_PIS } }
