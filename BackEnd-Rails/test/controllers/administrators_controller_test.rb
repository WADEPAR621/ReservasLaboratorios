...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference("Administrator.count") do
      post administrators_url, params: { administrator: { APE_ADM: @administrator.APE_ADM, COR_USE: @administrator.COR_USE, NOM_ADM: @administrator.NOM_ADM, SEC_USE: @administrator.SEC_USE } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { APE_ADM: @administrator.APE_ADM, COR_USE: @administrator.COR_USE, NOM_ADM: @administrator.NOM_ADM, SEC_USE: @administrator.SEC_USE } }
