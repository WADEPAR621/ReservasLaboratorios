        ...
        <>
            ...
            <div className="form-group__LOGIN">
                ...
                <div className="inputbox">
                    <input className="inputbox__input" type="text" required value={newCuenta.ncedula} onChange={(e) => setNewCuenta({ ...newCuenta, ncedula: e.target.value })} />
                    <label className="inputbox__label" htmlFor="">Numero de celular</label>
                </div>
                <div className="inputbox">
                    <input className="inputbox__input" type="date" required value={newCuenta.fechaNacimiento} onChange={(e) => setNewCuenta({ ...newCuenta, fechaNacimiento: e.target.value })} />
                    <label className="inputbox__label" htmlFor="inputbox__Date">Dia de Nacimiento</label>
                </div>
                <div className="inputbox">
                    <input className="inputbox__input" type="text" required value={newCuenta.correoElectronico} onChange={(e) => setNewCuenta({ ...newCuenta, correoElectronico: e.target.value })}/>
                    <label className="inputbox__label" htmlFor="">Correo Electronico</label>
                </div>
                <div className="inputbox">
                    <input className="inputbox__input" type="password" required value={newCuenta.contrasena} onChange={(e) => setNewCuenta({ ...newCuenta, contrasena: e.target.value })}/>
                    <label className="inputbox__label" htmlFor="">Contraseña</label>
                </div>
                <div className="inputbox">
                    <input className="inputbox__input"type="password"required/>
