...
class HorariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horario" do
    assert_difference("Horario.count") do
      post horarios_url, params: { horario: { Jueves: @horario.Jueves, Lunes: @horario.Lunes, Martes: @horario.Martes, Miercoles: @horario.Miercoles, Viernes: @horario.Viernes, hora_id: @horario.hora_id, room_id: @horario.room_id } }
    end
  ...
  test "should update horario" do
    patch horario_url(@horario), params: { horario: { Jueves: @horario.Jueves, Lunes: @horario.Lunes, Martes: @horario.Martes, Miercoles: @horario.Miercoles, Viernes: @horario.Viernes, hora_id: @horario.hora_id, room_id: @horario.room_id } }
